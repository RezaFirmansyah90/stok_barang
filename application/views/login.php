...
<head>
    ...
    <link rel="shortcut icon" href="<?= base_url('assets/img/LOGO DENIS_MOTOR-01.ico'); ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                <img src="<?= base_url('assets/img/denismotor.jpg'); ?>" class="login" style="width: 600px; height: 200px;"/>
                <h3 class="text-white mt-2">Aplikasi Stok Barang</h3>
<br><center><p>By Denis Motor</p></center>
