...
<nav id="sidebar">
    <div class="p-4 pt-5">
        <a href="<?= site_url(); ?>" class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/LOGOLOGO-01.jpg'); ?>);"></a>
        <ul class="list-unstyled components mb-5">
            ...
            <li <?= (in_array(strtolower($this->uri->segment(1)), ['data_pembelian', 'tambah_pembelian', 'edit_pembelian'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('data_pembelian'); ?>"><i class="fa fa-share"></i> Data Pembelian Barang</a>
            </li>

            <li <?= (in_array(strtolower($this->uri->segment(1)), ['data_penjualan', 'tambah_penjualan', 'edit_penjualan'])) ? 'class="active"' : ''; ?>>
                <a href="<?= site_url('data_penjualan'); ?>"><i class="fa fa-reply"></i> Data Penjualan Barang</a>
            </li>
        ...
        <div class="footer">
            <p>
                ...
                </script> All rights reserved | Reza Firmansyah
